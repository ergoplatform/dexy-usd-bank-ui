...
export const BankReservesGraph: React.FC = () => {
    ...
    <Box borderRadius={'xl'}>
      <Flex col position="relative">
        <Flex.Item marginTop={4} marginLeft={4} marginRight={4}>
          <Flex align="center">
            <Typography.Text>Bank Reserves</Typography.Text>
